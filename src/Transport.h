...
class Transport {
 public:
   ...
   */
  virtual int32_t transSend(NetworkContext_t *pNetworkContext,
                            const void *pBuffer, size_t bytesToSend) = 0;
   ...
   * @return
   */
  virtual int32_t transRead(NetworkContext_t *pNetworkContext, void *pBuffer,
   ...
   * @return number of bytes sent
   */
  static int32_t staticSend(NetworkContext_t *pNetworkContext,
   ...
   */
  static int32_t staticRead(NetworkContext_t *pNetworkContext, void *pBuffer,
                            size_t bytesToRecv);
